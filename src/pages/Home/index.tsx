...
import HomePromo from './Section/HomePromo';
import HomeProduct from './Section/HomeProduct';
import Button from '@/components/Button';

const Modal = lazy(() => import('@/components/Modal'));

const titleHeader = <p>Bergabung Dengan Kami</p>;
const contentBody = <p><b>Lorem Ipsum</b> is simply dummy text of the printing and typesetting industry.
...
function Home() {
  ...
  const contentFooter = <div style={{ display: 'flex', justifyContent: 'flex-end' }}><Button
    type='button'
    variant='primary'
  ...
  return (
    <Layout>
      <HomeBanner onShowModal={handleShowModal} />
      <HomePromo />
      <HomeProduct />
      <Modal
        isShow={showModal}
